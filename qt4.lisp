...
(defmethod checksum ((system (eql (asdf:find-system :qt4))) &key type)
  (when (equal (version system) "qt-libs1.1.3")
    (case type
      (:sources
       #(105 78 163 136 66 52 35 63 247 113 88 240 178 72 105 10 90 152 63 37 72 200
         92 149 192 140 139 41 234 205 8 100 141 65 44 131 11 12 202 51 15 177 22 113
         209 246 230 126 220 155 229 225 148 254 133 237 196 165 138 61 148 107 134 29))
      (:compiled
       #+(and linux x86-64)
