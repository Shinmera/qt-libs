  ...
  (when (equal (version system) "qt-libs1.1.0")
    (case type
      ...
      (:compiled
       ...
       #+(and darwin x86-64)
       #(47 74 46 182 233 156 41 18 101 196 0 0 161 6 86 14 63 199 152 105 171 204 153
         113 36 143 78 34 116 84 84 203 119 176 122 230 42 105 224 24 37 58 4 222 97
         26 128 103 29 88 11 97 114 94 34 193 38 202 151 109 40 7 137 191)
       #+(and windows x86-64)
